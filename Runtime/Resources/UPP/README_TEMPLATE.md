...
<span></span>
<a href="https://github.com/Rogue-source/Unity-Project-Patcher">Unity Project Patcher</a>
<span> · </span>
<a href="https://github.com/Rogue-source/Unity-Project-Patcher/issues/">Report Bug</a>
<span> · </span>
<a href="https://github.com/Rogue-source/Unity-Project-Patcher/issues/">Request Feature</a>
</h4>
...
<!-- About the Project -->
## About the Project
This tool is a game wrapper on top of the [Unity Project Patcher](https://github.com/Rogue-source/Unity-Project-Patcher).
...
- [.NET 8.0](https://dotnet.microsoft.com/en-us/download/dotnet/8.0)
    - To run Asset Ripper
- [Unity Project Patcher](https://github.com/Rogue-source/Unity-Project-Patcher)
...
4. Provide the URL of the this git repository: `https://github.com/Rogue-source/Unity-Project-Patcher.git`
...
```json
"com.nomnom.unity-project-patcher": "https://github.com/Rogue-source/Unity-Project-Patcher.git"
```
...
The core project's FAQ can be found here: https://github.com/Rogue-source/Unity-Project-Patcher#faq
