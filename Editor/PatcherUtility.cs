...
using Rogue.UnityProjectPatcher.AssetRipper;
...
namespace Rogue.UnityProjectPatcher.Editor {
    public static class PatcherUtility {
        ...
        public static UPPatcherUserSettings GetUserSettings() {
            return Rogue.UnityProjectPatcher.PatcherUtility.GetUserSettings();
        }
        ...
        public static UPPatcherSettings GetSettings() {
            return Rogue.UnityProjectPatcher.PatcherUtility.GetSettings();
        }
        ...
        public static AssetRipperSettings GetAssetRipperSettings() {
            return Rogue.UnityProjectPatcher.PatcherUtility.GetAssetRipperSettings();
        }
        ...
        public static (string version, string gameWrapperVersion) GetVersions(PackageCollection packages) {
            ...
            try {
                var patcher = packages.FirstOrDefault(x => x.name == "com.rogue.unity-project-patcher");
        ...
        internal static bool HasBuildBlocker() {
            return typeof(UPPatcherSettings).Assembly.GetType("Rogue.UnityProjectPatcher.BuildBlocker") != null;
        }
