...
namespace Rogue.UnityProjectPatcher.Editor.Steps {
    ...
    public readonly struct PromptUserWithAddressablePluginStep: IPatcherStep {
        public UniTask<StepResult> Run() {
            ...
            var pluginPath = Path.GetFullPath("Packages/com.rogue.unity-project-patcher/Editor/Plugin~/AddressablesScanner/AddressablesScanner.dll");
...
If Explorer didn't open, the plugin is located at ""[UNITY_PROJECT]/Packages/com.rogue.unity-project-patcher/Editor/Plugin~/AddressablesScanner/AddressablesScanner.dll""
